...
type TapiTopologyTopologyNode struct {
	...
	// none
	OwnedNodeEdgePoint []*TapiTopologyNodeOwnedNodeEdgePoint `json:"owned-node-edge-point"`
}
...
func (m *TapiTopologyTopologyNode) validateOwnedNodeEdgePoint(formats strfmt.Registry) error {
