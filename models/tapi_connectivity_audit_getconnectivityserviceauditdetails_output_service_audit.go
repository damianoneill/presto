...
// TapiConnectivityAuditGetconnectivityserviceauditdetailsOutputServiceAudit tapi connectivity audit getconnectivityserviceauditdetails output service audit
// swagger:model tapi.connectivity.audit.getconnectivityserviceauditdetails.output.ServiceAudit
type TapiConnectivityAuditGetconnectivityserviceauditdetailsOutputServiceAudit struct {
	...
	// none
	EndPoint []*TapiConnectivityAuditGetconnectivityserviceauditdetailsOutputServiceauditEndPoint `json:"end-point"`
}

// UnmarshalJSON unmarshals this object from a JSON structure
func (m *TapiConnectivityAuditGetconnectivityserviceauditdetailsOutputServiceAudit) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m TapiConnectivityAuditGetconnectivityserviceauditdetailsOutputServiceAudit) MarshalJSON() ([]byte, error) {
...
// Validate validates this tapi connectivity audit getconnectivityserviceauditdetails output service audit
func (m *TapiConnectivityAuditGetconnectivityserviceauditdetailsOutputServiceAudit) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TapiConnectivityAuditGetconnectivityserviceauditdetailsOutputServiceAudit) validateEndPoint(formats strfmt.Registry) error {
...
func (m *TapiConnectivityAuditGetconnectivityserviceauditdetailsOutputServiceAudit) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TapiConnectivityAuditGetconnectivityserviceauditdetailsOutputServiceAudit) UnmarshalBinary(b []byte) error {
	var res TapiConnectivityAuditGetconnectivityserviceauditdetailsOutputServiceAudit
