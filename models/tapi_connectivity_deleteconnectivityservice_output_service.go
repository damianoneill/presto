...
// TapiConnectivityDeleteconnectivityserviceOutputService tapi connectivity deleteconnectivityservice output service
// swagger:model tapi.connectivity.deleteconnectivityservice.output.Service
type TapiConnectivityDeleteconnectivityserviceOutputService struct {
	...
	// none
	EndPoint []*TapiConnectivityDeleteconnectivityserviceOutputServiceEndPoint `json:"end-point"`
...
func (m *TapiConnectivityDeleteconnectivityserviceOutputService) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m TapiConnectivityDeleteconnectivityserviceOutputService) MarshalJSON() ([]byte, error) {
...
// Validate validates this tapi connectivity deleteconnectivityservice output service
func (m *TapiConnectivityDeleteconnectivityserviceOutputService) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TapiConnectivityDeleteconnectivityserviceOutputService) validateDirection(formats strfmt.Registry) error {
...
func (m *TapiConnectivityDeleteconnectivityserviceOutputService) validateEndPoint(formats strfmt.Registry) error {
...
func (m *TapiConnectivityDeleteconnectivityserviceOutputService) validateLayerProtocolName(formats strfmt.Registry) error {
...
func (m *TapiConnectivityDeleteconnectivityserviceOutputService) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TapiConnectivityDeleteconnectivityserviceOutputService) UnmarshalBinary(b []byte) error {
	var res TapiConnectivityDeleteconnectivityserviceOutputService
