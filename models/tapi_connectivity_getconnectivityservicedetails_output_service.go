...
// TapiConnectivityGetconnectivityservicedetailsOutputService tapi connectivity getconnectivityservicedetails output service
// swagger:model tapi.connectivity.getconnectivityservicedetails.output.Service
type TapiConnectivityGetconnectivityservicedetailsOutputService struct {
	...
	// none
	EndPoint []*TapiConnectivityGetconnectivityservicedetailsOutputServiceEndPoint `json:"end-point"`
...
func (m *TapiConnectivityGetconnectivityservicedetailsOutputService) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m TapiConnectivityGetconnectivityservicedetailsOutputService) MarshalJSON() ([]byte, error) {
...
// Validate validates this tapi connectivity getconnectivityservicedetails output service
func (m *TapiConnectivityGetconnectivityservicedetailsOutputService) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TapiConnectivityGetconnectivityservicedetailsOutputService) validateDirection(formats strfmt.Registry) error {
...
func (m *TapiConnectivityGetconnectivityservicedetailsOutputService) validateEndPoint(formats strfmt.Registry) error {
...
func (m *TapiConnectivityGetconnectivityservicedetailsOutputService) validateLayerProtocolName(formats strfmt.Registry) error {
...
func (m *TapiConnectivityGetconnectivityservicedetailsOutputService) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TapiConnectivityGetconnectivityservicedetailsOutputService) UnmarshalBinary(b []byte) error {
	var res TapiConnectivityGetconnectivityservicedetailsOutputService
