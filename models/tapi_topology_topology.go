...
// TapiTopologyTopology tapi topology topology
// swagger:model tapi.topology.Topology
...
func (m *TapiTopologyTopology) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m TapiTopologyTopology) MarshalJSON() ([]byte, error) {
...
// Validate validates this tapi topology topology
func (m *TapiTopologyTopology) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TapiTopologyTopology) validateLayerProtocolName(formats strfmt.Registry) error {
...
func (m *TapiTopologyTopology) validateLink(formats strfmt.Registry) error {
...
func (m *TapiTopologyTopology) validateNode(formats strfmt.Registry) error {
...
func (m *TapiTopologyTopology) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TapiTopologyTopology) UnmarshalBinary(b []byte) error {
	var res TapiTopologyTopology
