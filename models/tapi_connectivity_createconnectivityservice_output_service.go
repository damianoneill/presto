...
// TapiConnectivityCreateconnectivityserviceOutputService tapi connectivity createconnectivityservice output service
// swagger:model tapi.connectivity.createconnectivityservice.output.Service
type TapiConnectivityCreateconnectivityserviceOutputService struct {
	...
	// none
	EndPoint []*TapiConnectivityCreateconnectivityserviceOutputServiceEndPoint `json:"end-point"`
...
func (m *TapiConnectivityCreateconnectivityserviceOutputService) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m TapiConnectivityCreateconnectivityserviceOutputService) MarshalJSON() ([]byte, error) {
...
// Validate validates this tapi connectivity createconnectivityservice output service
func (m *TapiConnectivityCreateconnectivityserviceOutputService) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TapiConnectivityCreateconnectivityserviceOutputService) validateDirection(formats strfmt.Registry) error {
...
func (m *TapiConnectivityCreateconnectivityserviceOutputService) validateEndPoint(formats strfmt.Registry) error {
...
func (m *TapiConnectivityCreateconnectivityserviceOutputService) validateLayerProtocolName(formats strfmt.Registry) error {
...
func (m *TapiConnectivityCreateconnectivityserviceOutputService) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TapiConnectivityCreateconnectivityserviceOutputService) UnmarshalBinary(b []byte) error {
	var res TapiConnectivityCreateconnectivityserviceOutputService
