...
// TapiConnectivityAuditConnectivityServiceAudit tapi connectivity audit connectivity service audit
// swagger:model tapi.connectivity.audit.ConnectivityServiceAudit
type TapiConnectivityAuditConnectivityServiceAudit struct {
...
func (m *TapiConnectivityAuditConnectivityServiceAudit) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m TapiConnectivityAuditConnectivityServiceAudit) MarshalJSON() ([]byte, error) {
...
// Validate validates this tapi connectivity audit connectivity service audit
func (m *TapiConnectivityAuditConnectivityServiceAudit) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TapiConnectivityAuditConnectivityServiceAudit) validateEndPoint(formats strfmt.Registry) error {
...
func (m *TapiConnectivityAuditConnectivityServiceAudit) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TapiConnectivityAuditConnectivityServiceAudit) UnmarshalBinary(b []byte) error {
	var res TapiConnectivityAuditConnectivityServiceAudit
